...
alter table tag2post add constraint FK_TAG2POSTS_ON_POST foreign key (post_id) references posts (id);
alter table tag2post add constraint FK_TAG2POSTS_ON_TAG foreign key (tag_id) references tags (id);
